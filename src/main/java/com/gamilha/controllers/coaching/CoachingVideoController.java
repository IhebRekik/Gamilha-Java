...
public class CoachingVideoController {
    ...
    private VBox createVideoCard(CoachingVideo v) {
        ...
        voir.setOnAction(e -> { selectedVideo = v; navigateTo("/User/VideoShow.fxml"); });
        ...
        if (isAdmin()) {
            ...
            modifier.setOnAction(e  -> { selectedVideo = v; editMode = true; navigateTo("/Admin/VideoForm.fxml"); });
    ...
    @FXML private void handleAdd() {
        ...
        navigateTo("/Admin/VideoForm.fxml");
    }
    ...
    private void initFormPage() {
        ...
        if (btnCancelVideo != null) btnCancelVideo.setOnAction(e -> { editMode = false; selectedVideoPath = null; navigateTo("/Admin/VideoList.fxml"); });
    }
    ...
    private void initShowPage() {
        if (selectedVideo == null) { navigateTo("/Admin/VideoList.fxml"); return; }
        ...
        if (btnRetourVideo    != null) btnRetourVideo.setOnAction(e -> { stopPlayer(); navigateTo("/Admin/VideoList.fxml"); });
        if (btnModifierVideo  != null) btnModifierVideo.setOnAction(e -> { stopPlayer(); editMode = true; navigateTo("/Admin/VideoForm.fxml"); });
