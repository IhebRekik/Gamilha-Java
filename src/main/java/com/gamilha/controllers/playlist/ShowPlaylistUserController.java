...
public class ShowPlaylistUserController {
    ...
    private void chargerVideos() {
        ...
        ColumnConstraints c3 = new ColumnConstraints(); c3.setPercentWidth(14);
        ColumnConstraints c4 = new ColumnConstraints(); c4.setPercentWidth(14);
        ColumnConstraints c5 = new ColumnConstraints(); c5.setPercentWidth(16);
        ...
        for (CoachingVideo v : videos) {
            ...
            addCell(v.isPremium() ? "✅ Oui" : "❌ Non", row, 4, color);
            row++;
        }
