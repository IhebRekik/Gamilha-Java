...
import com.gamilha.controllers.Messages.ConversationController;
...
public class UserAmisController implements Initializable {
    ...
    -fx-text-fill:white;
    -fx-background-radius:20;-fx-border-width:1;-fx-font-size:12;-fx-cursor:hand;-fx-padding:6 14;
""");
        msgBtn.setOnAction(e -> ouvrirConversation(u));
        ...
        row.getChildren().addAll(sp, info, btnRetirer,msgBtn);
        return row;
    }
    ...
    private void ouvrirConversation(User user) {
        try {
            ...
            // passer utilisateur sélectionné
            controller.setUser(user);

            Stage stage = new Stage();
            stage.setTitle("Conversation avec " + user.getName());
