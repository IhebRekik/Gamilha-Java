...
public class StreamListController implements Initializable {
    ...
    private VBox buildCard(Stream stream) {
        ...
        btnDonate.setOnAction(e -> {
            DonationFormController c = MainApp.loadSceneWithController("User/DonationForm.fxml");
    ...
    @FXML private void onNewStream(ActionEvent e) { StreamFormController c = MainApp.loadSceneWithController("User/StreamForm.fxml"); if (c != null) c.initCreate(); }
